...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-Ym7HXxzg.mjs";
...
const dependencies = {
  ...
  "@strapi/icons": "1.19.0",
  "@strapi/permissions": "4.25.5",
  "@strapi/provider-audit-logs-local": "4.25.5",
  "@strapi/types": "4.25.5",
  "@strapi/typescript-utils": "4.25.5",
  "@strapi/utils": "4.25.5",
...
const devDependencies = {
  "@strapi/admin-test-utils": "4.25.5",
  "@strapi/data-transfer": "4.25.5",
  "@strapi/pack-up": "4.23.0",
  "@strapi/plugin-content-manager": "4.25.5",
...
const CM = React.lazy(
  () => import("./index-Ym7HXxzg.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-XjFohnai.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-x5iEQZfz.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-7U4KSL8e.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-Ym7HXxzg.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-EWuRAulm.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-LKHUlz_u.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-cgB50fx0.mjs.map
