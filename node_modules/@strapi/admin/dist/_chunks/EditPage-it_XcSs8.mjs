...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-Ym7HXxzg.mjs";
...
import { u as useWebhooks } from "./useWebhooks-lsXuAuvn.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-IfgZFdq3.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-it_XcSs8.mjs.map
