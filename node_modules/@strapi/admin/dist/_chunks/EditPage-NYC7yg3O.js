...
const useWebhooks = require("./useWebhooks-dOdDpDWh.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-CFoLua_8.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-NYC7yg3O.js.map
