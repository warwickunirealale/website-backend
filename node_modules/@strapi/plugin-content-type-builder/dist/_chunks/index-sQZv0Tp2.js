...
const index$1 = require("./index-UWN53VN9.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-OCfYqnvx.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-OCfYqnvx.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-sQZv0Tp2.js.map
