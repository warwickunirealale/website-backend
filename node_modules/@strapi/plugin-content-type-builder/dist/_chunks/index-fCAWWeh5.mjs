...
const ListView$1 = lazy(() => import("./ListView-TZ0seS-c.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-TZ0seS-c.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-fCAWWeh5.mjs.map
